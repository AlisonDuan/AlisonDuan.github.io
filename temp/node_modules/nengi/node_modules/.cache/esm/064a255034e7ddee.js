let ProtocolMap,metaConfig,createHandshakeBuffer,readSnapshotBuffer,EntityCache,WorldState,Outbound,Interpolator,createPongBuffer,Chronus,Predictor,EventEmitter;_34e‍.x([["default",()=>_34e‍.o]]);_34e‍.w("../protocol/ProtocolMap",[["default",["ProtocolMap"],function(v){ProtocolMap=v}]]);_34e‍.w("../common/metaConfig",[["default",["metaConfig"],function(v){metaConfig=v}]]);_34e‍.w("../snapshot/writer/createHandshakeBuffer",[["default",["createHandshakeBuffer"],function(v){createHandshakeBuffer=v}]]);_34e‍.w("../snapshot/reader/readSnapshotBuffer",[["default",["readSnapshotBuffer"],function(v){readSnapshotBuffer=v}]]);_34e‍.w("../instance/EntityCache",[["default",["EntityCache"],function(v){EntityCache=v}]]);_34e‍.w("./WorldState",[["default",["WorldState"],function(v){WorldState=v}]]);_34e‍.w("./Outbound",[["default",["Outbound"],function(v){Outbound=v}]]);_34e‍.w("./Interpolator",[["default",["Interpolator"],function(v){Interpolator=v}]]);_34e‍.w("../snapshot/writer/createPongBuffer",[["default",["createPongBuffer"],function(v){createPongBuffer=v}]]);_34e‍.w("./Chronus",[["default",["Chronus"],function(v){Chronus=v}]]);_34e‍.w("./Predictor",[["default",["Predictor"],function(v){Predictor=v}]]);_34e‍.w("events",[["EventEmitter",["EventEmitter"],function(v){EventEmitter=v}]]);
...
class Client extends EventEmitter {
    ...
    connect(address, handshake) {
        ...
        this.websocket.onerror = (err) => {
            _34e‍.g.console.log('WebSocket error', err)
        }
    ...
    mockConnect(mockSocket, handshake) {
        ...
        this.websocket.on('message', (message) => {
            _34e‍.g.console.log('message', message)
