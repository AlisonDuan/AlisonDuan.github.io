let isBatchAtomiclyValid,compare,getValue;_34e‍.x([["default",()=>chooseOptimization]]);_34e‍.w("./isBatchAtomiclyValid",[["default",["isBatchAtomiclyValid"],function(v){isBatchAtomiclyValid=v}]]);_34e‍.w("../../protocol/compare",[["default",["compare"],function(v){compare=v}]]);_34e‍.w("../../protocol/getValue",[["default",["getValue"],function(v){getValue=v}]]);
...
// 3 cases: batch update, single prop update, or no update needed
               function chooseOptimization(idPropertyName, oldProxy, newProxy, protocol) {
