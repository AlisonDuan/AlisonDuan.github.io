let WebSocketServer,EDictionary,Historian,IdPool,proxify,compare,copyProxy,Binary,BinaryType,formatUpdates,chooseOptimization,ProtocolMap,Client,createSnapshotBuffer,readCommandBuffer,createConnectionResponseBuffer,createTransferClientBuffer,createTransferRequestBuffer,createTransferResponseBuffer,createHandshakeBuffer,consoleLogLogo,metaConfig,NoInterpsMessage,Sleep,BasicSpace,EventEmitter,Channel;_34e‍.x([["default",()=>_34e‍.o]]);_34e‍.w("@clusterws/cws",[["WebSocketServer",["WebSocketServer"],function(v){WebSocketServer=v}]]);_34e‍.w("../../external/EDictionary",[["default",["EDictionary"],function(v){EDictionary=v}]]);_34e‍.w("./Historian",[["default",["Historian"],function(v){Historian=v}]]);_34e‍.w("./IdPool",[["default",["IdPool"],function(v){IdPool=v}]]);_34e‍.w("../protocol/proxify",[["default",["proxify"],function(v){proxify=v}]]);_34e‍.w("../protocol/compare",[["default",["compare"],function(v){compare=v}]]);_34e‍.w("../protocol/copyProxy",[["default",["copyProxy"],function(v){copyProxy=v}]]);_34e‍.w("../binary/Binary",[["default",["Binary"],function(v){Binary=v}]]);_34e‍.w("../binary/BinaryType",[["default",["BinaryType"],function(v){BinaryType=v}]]);_34e‍.w("../snapshot/entityUpdate/formatUpdates",[["default",["formatUpdates"],function(v){formatUpdates=v}]]);_34e‍.w("../snapshot/entityUpdate/chooseOptimization",[["default",["chooseOptimization"],function(v){chooseOptimization=v}]]);_34e‍.w("../protocol/ProtocolMap",[["default",["ProtocolMap"],function(v){ProtocolMap=v}]]);_34e‍.w("./Client",[["default",["Client"],function(v){Client=v}]]);_34e‍.w("../snapshot/writer/createSnapshotBuffer",[["default",["createSnapshotBuffer"],function(v){createSnapshotBuffer=v}]]);_34e‍.w("../snapshot/reader/readCommandBuffer",[["default",["readCommandBuffer"],function(v){readCommandBuffer=v}]]);_34e‍.w("../snapshot/writer/createConnectionResponseBuffer",[["default",["createConnectionResponseBuffer"],function(v){createConnectionResponseBuffer=v}]]);_34e‍.w("../snapshot/writer/createTransferClientBuffer",[["default",["createTransferClientBuffer"],function(v){createTransferClientBuffer=v}]]);_34e‍.w("../snapshot/writer/createTransferRequestBuffer",[["default",["createTransferRequestBuffer"],function(v){createTransferRequestBuffer=v}]]);_34e‍.w("../snapshot/writer/createTransferResponseBuffer",[["default",["createTransferResponseBuffer"],function(v){createTransferResponseBuffer=v}]]);_34e‍.w("../snapshot/writer/createHandshakeBuffer",[["default",["createHandshakeBuffer"],function(v){createHandshakeBuffer=v}]]);_34e‍.w("../common/consoleLogLogo",[["default",["consoleLogLogo"],function(v){consoleLogLogo=v}]]);_34e‍.w("../common/metaConfig",[["default",["metaConfig"],function(v){metaConfig=v}]]);_34e‍.w("../common/NoInterpsMessage",[["default",["NoInterpsMessage"],function(v){NoInterpsMessage=v}]]);_34e‍.w("./Sleep",[["default",["Sleep"],function(v){Sleep=v}]]);_34e‍.w("./BasicSpace",[["default",["BasicSpace"],function(v){BasicSpace=v}]]);_34e‍.w("events",[["EventEmitter",["EventEmitter"],function(v){EventEmitter=v}]]);_34e‍.w("./Channel",[["default",["Channel"],function(v){Channel=v}]]);
...
class Instance extends EventEmitter {
    ...
    onMessage(message, client) {
        try {
            ...
            if (err) {
                _34e‍.g.console.log('onMessage error, disconnecting client', err)
    ...
    proxifyOrGetCachedProxy(tick, entity) {
        if (this.proxyCache[tick].entities[entity.id]) {
            ...
            if (!entity.protocol) {
                _34e‍.g.console.log('PROBLEM Entity/Component:', entity)
